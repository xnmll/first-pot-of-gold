<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="userInfo.aspx.cs" Inherits="HTRoomMgmtInfoSys.form.userInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" Width="800px" Height="400px" AllowPaging="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="6" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting">
        <Columns>
            ...
            <asp:BoundField DataField="u_pwd" HeaderText="密码">
            <ControlStyle Height="25px" Width="70px" />
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="120px" />
            </asp:BoundField>
            <asp:BoundField DataField="u_phone" HeaderText="手机号">
            <ControlStyle Height="25px" Width="70px" />
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="120px" />
            </asp:BoundField>
            ...
            <asp:TemplateField HeaderText="删除用户" ShowHeader="False">
                <ItemTemplate>
