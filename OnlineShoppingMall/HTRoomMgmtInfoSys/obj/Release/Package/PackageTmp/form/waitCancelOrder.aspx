<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="waitCancelOrder.aspx.cs" Inherits="HTRoomMgmtInfoSys.form.waitCancelOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <Columns>
        <asp:TemplateField HeaderText="取消订单" ShowHeader="False">
            <ItemTemplate>
                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="layui-btn layui-btn-xs layui-btn-normal" CausesValidation="False" CommandName="Select" Text="确认取消"></asp:LinkButton>
            </ItemTemplate>
