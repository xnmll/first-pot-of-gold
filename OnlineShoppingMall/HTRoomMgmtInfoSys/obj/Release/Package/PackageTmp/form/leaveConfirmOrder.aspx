<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="leaveConfirmOrder.aspx.cs" Inherits="HTRoomMgmtInfoSys.form.leaveConfirmOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <Columns>
        <asp:TemplateField HeaderText="离店确认" ShowHeader="False">
            <ItemTemplate>
                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="layui-btn layui-btn-xs layui-btn-normal" CausesValidation="False" CommandName="Select" Text="确认离店"></asp:LinkButton>
            </ItemTemplate>
