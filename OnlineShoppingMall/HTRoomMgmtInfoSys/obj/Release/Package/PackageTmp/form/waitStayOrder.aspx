<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="waitStayOrder.aspx.cs" Inherits="HTRoomMgmtInfoSys.form.waitStayOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <Columns>
        <asp:TemplateField HeaderText="确认入住" ShowHeader="False">
            <ItemTemplate>
                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="layui-btn layui-btn-xs layui-btn-normal" CausesValidation="False" CommandName="Select" Text="确认入住"></asp:LinkButton>
            </ItemTemplate>
